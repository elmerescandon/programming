...
I1A = cv2.imread('chavin.jpg',0)          # queryImage
I2B = cv2.imread('testeo.jpg',0) # trainImage
I1 = cv2.resize(I1A, None, fx=0.2, fy=0.2, interpolation=cv2.INTER_LINEAR)
I2 = cv2.resize(I2B, None, fx=0.2, fy=0.2, interpolation=cv2.INTER_LINEAR)
