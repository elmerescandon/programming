...
select cod_dept"Departamento",count(cod_dept) "N�mero de empleados"
from empleados
group by cod_dept
...
-- Ejercicio 4 - Uniones
-- Uniones naturales: Une las tablas seg�n correspondencia
...
-- Unir el campo en com�n
select e.nombre_emp, e.salario, d.nombre_dept,cod_dept
from empleados e JOIN depart d
using (cod_dept);

-- Uso del comando ON para unir tablas
-- Hacer uni�n de columnas que significan lo mismo pero tienen
